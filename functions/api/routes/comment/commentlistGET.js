...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const comment = await commentDB.getComments(client, postId);
    ...
    res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.READ_ALL_USERS_SUCCESS, comment, totalCount));
